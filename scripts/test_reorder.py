...
if sys.argv[1]=='start':
    ...
    # REORDER
    os.system('dada_db -k bada -b 201326592 -l -p -c 0 -n 8') # 2048 packets

    
    # start code    
    junk = 'dada_junkdb -t 1000 -k dada -r 1500 /home/ubuntu/proj/dsa110-shell/dsa110-xengine/src/correlator_header_dsaX.txt'
    reorder = '/home/ubuntu/proj/dsa110-shell/dsa110-xengine/src/dsaX_reorder_raw -t 16 -i dada -o bada'
