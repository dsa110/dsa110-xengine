...
my_pt_dec = float(sys.argv[1]) # degrees
iNode = int(sys.argv[2]) # node number for freqs
bfweights_path = "/home/ubuntu/proj/dsa110-shell/dsa110-xengine/utils/antennas.out"
vis_path = "/home/ubuntu/data/visModel.npz"
caltable_path = "/home/ubuntu/data/calTable.out"
